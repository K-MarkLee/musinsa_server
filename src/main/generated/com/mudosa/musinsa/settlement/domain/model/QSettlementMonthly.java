...
/**
 * QSettlementMonthly is a Querydsl query type for SettlementMonthly
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QSettlementMonthly extends EntityPathBase<SettlementMonthly> {

    private static final long serialVersionUID = 160218282L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QSettlementMonthly settlementMonthly = new QSettlementMonthly("settlementMonthly");
    ...
    public final DatePath<java.time.LocalDate> monthEndDate = createDate("monthEndDate", java.time.LocalDate.class);

    public final DatePath<java.time.LocalDate> monthStartDate = createDate("monthStartDate", java.time.LocalDate.class);
    ...
    public QSettlementMonthly(String variable) {
        this(SettlementMonthly.class, forVariable(variable), INITS);
    }

    public QSettlementMonthly(Path<? extends SettlementMonthly> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QSettlementMonthly(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QSettlementMonthly(PathMetadata metadata, PathInits inits) {
        this(SettlementMonthly.class, metadata, inits);
    }

    public QSettlementMonthly(Class<? extends SettlementMonthly> type, PathMetadata metadata, PathInits inits) {
